...
const main = async () => {
  ...
  for (const poll_id of polls) {
    ...
    const pollVotedInfoButton1 = await kv.smembers(`poll:${poll_id}:voted1`)
    const pollVotedInfoButton2 = await kv.smembers(`poll:${poll_id}:voted2`)
    console.log('pollInfo', pollInfo)
    console.log('pool voted info', pollVotedInfo)
    console.log('pool voted 1', pollVotedInfoButton1)
    console.log('pool voted 2', pollVotedInfoButton2)
  }
}
